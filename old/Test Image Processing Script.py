...
threshold_list = [255]  # Out of 255

# Turn the .tiff file into a png and save it
microscope_img = cv2.imread("fake_microsope 2.tiff", 0)
...
method_1_dict = plotting.plot_multiple_threshold_scenarios_test(
    threshold_list, microscope_img, 255, "fake_microsope.json", "Method 1"
)
# method_2_1_dict = plotting.plot_multiple_threshold_scenarios_test(
#    threshold_list, microscope_img, 255, "fake_microsope.json", "Method 2_1"
# )
# method_2_2_dict = plotting.plot_multiple_threshold_scenarios_test(
#    threshold_list, microscope_img, 255, "fake_microsope.json", "Method 2_2"
# )
# method_2_3_dict = plotting.plot_multiple_threshold_scenarios_test(
#    threshold_list, microscope_img, 255, "fake_microsope.json", "Method 2_3"
# )

# Plot a grouped bar chart of the results
plotting.grouped_bar_thresholds_methods(
    "Method 2_1 vs Method 2_2",
    [method_1_dict, method_2_1_dict, method_2_2_dict, method_2_3_dict],
)
